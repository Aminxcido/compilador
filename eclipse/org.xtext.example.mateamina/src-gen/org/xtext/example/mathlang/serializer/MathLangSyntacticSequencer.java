...
public class MathLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MathLangGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MathLangGrammarAccess) access;
	 ...
	 *     (rule start) (ambiguity) '-' operand=Unary
	 *     (rule start) (ambiguity) func='cos'
	 *     (rule start) (ambiguity) func='frac'
	 *     (rule start) (ambiguity) func='ln'
	 *     (rule start) (ambiguity) func='log'
	 *     (rule start) (ambiguity) func='sin'
	 *     (rule start) (ambiguity) func='sqrt'
	 *     (rule start) (ambiguity) func='tan'
	 *     (rule start) (ambiguity) left=Variable
