 ...
 */
package org.xtext.example.arithmetic.ide.contentassist.antlr;
...
import org.xtext.example.arithmetic.ide.contentassist.antlr.internal.InternalArithmeticParser;
...
public class ArithmeticParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ArithmeticGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMultiplicationAccess().getAlternatives_1_1(), "rule__Multiplication__Alternatives_1_1");
			...
			builder.put(grammarAccess.getModelAccess().getExprAssignment(), "rule__Model__ExprAssignment");
